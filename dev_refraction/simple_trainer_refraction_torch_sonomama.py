...
from refraction_transform import Refraction, RefractionSTE
...
class Config:
    ...
    prune_every: int = 14_999
    prune_opa: float = 0.005
    prune_large_gs: bool = True
    prune_scale3d: float = 30.0
...
class Runner:
    ...
    def refractive_rasterize_splats(
        ...
        **kwargs,
        ...
        if flag_refraction and use_custom_ste == False:
        ...
        if flag_refraction and use_custom_ste:
