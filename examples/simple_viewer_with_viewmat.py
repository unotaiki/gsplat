...
def main(local_rank: int, world_rank, world_size: int, args):
    ...
    def viewer_render_fn(camera_state: nerfview.CameraState, img_wh: Tuple[int, int]):
        ...
        viewmat_str = np.array2string(viewmat.cpu().numpy(), precision=2, separator=", ")
    ...
    gui = server.gui
    viewmat_tab = gui.add_tab_group(order=10, visible=True)
    viewmat_text = viewmat_tab.add_tab(label="View Matrix")
