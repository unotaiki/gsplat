...
class TransformWaterSurface():
    ...
    def forward(ctx,
        ...
        WS = WaterSurface(
            ...
            n=n,
            plane=plane,
            flag_solve_quartic_by_newton=flag_solve_quartic_by_newton, 
            newton_iters=num_newton_iters, 
...
class WaterSurface():
    ...
    def calc_apparent_quaternion(self,
        ...
        d_vertical = d_ra[:, 2]  # Vertical component of the apparent direction
